define(["doh/main", "require", "dojo/sniff"], function(doh, require, has){
	...
	// Bidi support
//	doh.register("form.TextBox_numeralShaping", require.toUrl("./TextBox_numericShaping.html"), 30000);
//	doh.register("form.TextBoxMixin", require.toUrl("./TextBoxMixin.html"), 180000);
/*
